...
title Projeqt-Ayla Discord Bot (Development)
...
if exist "frontend\package.json" (
    ...
    popd
    echo [INFO] Starting Vite frontend dev server in background window...
    start "Projeqt-Ayla Frontend (Vite Dev)" cmd /c "cd frontend && bun run dev"
)
